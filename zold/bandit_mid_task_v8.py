...
# ════════════════════════════════════════════════════════════════════════════
TASK_VERSION = 'v8'              # stamped into every data row for provenance
...
def main():
    ...
    def bandit_trial():
        ...
        tilts = [int(srand() * 15) - 7 for _ in range(4)]   # srandInt(-7,7); 4 draws kept so the cosmetic stream stays aligned across win/loss
